    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-[#0f0f12] border border-white/5 rounded-2xl p-5 space-y-3">
          ...
          <p className="text-xs text-slate-600">{status?.qcad_pro_ok ? "QCAD Pro detected" : "QCAD Pro: not found (PDF via ezdxf)"}</p>
        </div>
        <div className="bg-[#0f0f12] border border-white/5 rounded-2xl p-5 space-y-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        {[
          ...
          <a key={item.href} href={item.href} className="bg-[#0f0f12] border border-white/5 rounded-2xl p-4 text-center hover:border-amber-500/20 transition-all">
