...
export default function ViewerPage() {
	...
	return (
		<div className="space-y-6 max-w-6xl">
			...
			{svgUrl && (
				<div
					className="bg-[#1e1e26] border border-white/10 rounded-2xl p-4 overflow-auto"
				...
				<div className="bg-[#1e1e26] border border-white/10 rounded-2xl p-4 space-y-2">
					...
					<div className="grid grid-cols-3 gap-2 text-sm">
						<div className="text-slate-300">
							Entities: <span className="text-slate-300">{info.entity_total}</span>
						</div>
						<div className="text-slate-300">
							Layers: <span className="text-slate-300">{info.layer_count}</span>
						</div>
						<div className="text-slate-300">
							Blocks: <span className="text-slate-300">{info.block_count}</span>
						</div>
						<div className="text-slate-300">
							DXF Version: <span className="text-slate-300">{info.dxf_version}</span>
						</div>
						{info.bounding_box && (
