...
import { Upload, Loader2, Download, Box, Settings2 } from "lucide-react";
    ...
    <div className="max-w-3xl space-y-6">
      ...
      {result && (
        <div className="p-4 rounded-xl bg-emerald-950/30 border border-emerald-500/20 space-y-2">
          <p className="text-emerald-400 font-bold flex items-center gap-2"><Download size={16} /> Extrusion Complete</p>
